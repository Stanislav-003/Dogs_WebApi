...
namespace DogsReviewApp.Controllers
{
    ...
    public class CategoryController : Controller
    {
        ...
        {
            var dogs = _mapper.Map<List<DogDto>>(_categoryRepository.GetDogByCategory(categoryId));
        ...
        { 
            ...
            {
                ModelState.AddModelError("", "Something went wrong to updating category!");
                return StatusCode(500, ModelState);
            }
        ...
        public IActionResult DeleteCategory(int categoryId)
        {
            ...
            {
                ModelState.AddModelError("", "Something went wrong to delete category!");
            }
