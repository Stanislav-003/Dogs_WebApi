...
namespace DogsReviewApp.Controllers
{
    ...
    public class CountryController : Controller
    {
        ...
        [ProducesResponseType(400)]
        [ProducesResponseType(200, Type = typeof(Country))]
        public IActionResult GetCounrtyOfAnOwner(int ownerId)
        {
        ...
        public IActionResult UpdateCountry(int countryId, [FromBody] CountryDto updateCountry)
        {
            ...
            {
                ModelState.AddModelError("", "Something went wrong to updating country!");
                return StatusCode(500, ModelState);
            }
        ...
        public IActionResult DeleteCategory(int countryId)
        {
            ...
            {
                ModelState.AddModelError("", "Something went wrong to delete country!");
            }
